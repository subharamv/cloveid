                ...
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-gray-200 dark:border-b-gray-700 px-4 py-3 bg-white dark:bg-gray-800 shadow-md">
                    ...
                    <div className="flex items-center justify-end gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold hidden md:block">{profile?.full_name || user?.user_metadata?.full_name || 'User'}</span>
                        </div>
                        ...
                        <button onClick={handleLogout} className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 w-10 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <main className="flex-1 px-4 py-8 sm:px-6 lg:px-10">
                    ...
                    {loading || authLoading ? (
                        <div className="flex h-[60vh] items-center justify-center">
                            <div className="h-8 w-8 animate-spin rounded-full border-4 border-[#f48120] border-t-transparent"></div>
                        </div>
                    ) : (
                        <>
