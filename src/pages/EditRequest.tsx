...
const EditRequest: React.FC = () => {
    ...
    useEffect(() => {
        const requests = [
            { id: 1, name: 'John Doe', employeeId: 'E12345', date: '2024-07-29', status: 'Pending', bloodGroup: 'A+', branch: 'New York', emergencyContact: '1234567890' },
            { id: 2, name: 'Jane Smith', employeeId: 'E67890', date: '2024-07-28', status: 'Approved', bloodGroup: 'B+', branch: 'London', emergencyContact: '0987654321' },
            { id: 3, name: 'Peter Jones', employeeId: 'E11223', date: '2024-07-27', status: 'Rejected', bloodGroup: 'O-', branch: 'Sydney', emergencyContact: '1122334455' },
        ];
