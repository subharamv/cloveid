    ...
    useEffect(() => {
        const fetchDepartments = async () => {
            try {
                ...
                // Fallback to static departments if DB fetch fails
                            ...
                            <div className="flex flex-col items-center justify-center bg-background-light dark:bg-background-dark p-6 md:p-10">
                                <div className="flex w-full max-w-md flex-col gap-6 rounded-lg bg-white dark:bg-background-dark md:bg-transparent md:dark:bg-transparent p-6 md:p-0">
                                    <div className="flex items-center gap-3">
                                        <img src={branding.logo_login || branding.logo_header || cloveLogo} alt="Logo" className="h-8" />
                                    </div>
                                ...
                                <div className="w-full max-w-md">
                                    <div className="flex px-4 py-3">
                                        <div className="flex h-10 flex-1 items-center justify-center rounded-lg bg-background-light dark:bg-background-dark p-1">
                                            ...
                                            <label className={`flex cursor-pointer h-full grow items-center justify-center overflow-hidden rounded-lg px-2 ${!isLoginView ? 'bg-white dark:bg-zinc-700 shadow-[0_0_4px_rgba(0,0,0,0.1)] text-[#111418] dark:text-white' : 'text-[#617289] dark:text-gray-400'} text-sm font-medium leading-normal`} onClick={() => { setIsLoginView(false); setIsForgotView(false); }}>
                                    ...
                                    {isForgotView ? (
                                        <form className="flex flex-col" onSubmit={handleForgotPassword}>
                                            <h1 className="text-[#111418] dark:text-white tracking-light text-[32px] font-bold leading-tight px-4 text-left pb-3 pt-6">Reset Password</h1>
                                            <p className="px-4 text-[#617289] dark:text-gray-400 text-sm mb-4">Enter your email and we'll send you a link to reset your password.</p>
                                        ...
                                        <form className="flex flex-col" onSubmit={handleRegister}>
                                            ...
                                            <div className="flex w-full flex-col gap-4 px-4 py-3">
                                                ...
                                                <label className="flex flex-col min-w-40 flex-1">
                                                    <p className="text-[#111418] dark:text-gray-200 text-base font-medium leading-normal pb-2">Department</p>
                                                    <select
                                                        className="form-select flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111418] dark:text-white focus:outline-0 focus:ring-0 border border-[#dbe0e6] dark:border-zinc-700 bg-white dark:bg-zinc-800 focus:border-primary h-14 placeholder:text-[#617289] dark:placeholder:text-gray-500 p-[15px] text-base font-normal leading-normal"
                                                        name="department"
                                                        value={department}
